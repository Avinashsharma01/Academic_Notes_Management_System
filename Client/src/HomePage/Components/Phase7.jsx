            ...
            {phase7Info.map((items, index) => (
                <div key={index} className={styles.Phase7_main_container}>
                    <div className={styles.container1}>
                        <h1
                            className={[styles.titel1, "phase7-titel1"].join(
                                " "
                            )}
                        >
                            {items.heading1}
                        ...
                        <p
                            className={[styles.titel2, "phase7-titel2"].join(
                                " "
                            )}
                        >
                            {items.heading2}
